...
public class TSOA {
    ...
    public static String run(String frontSalt, String middleSalt, String backSalt, int offsetValue, String password){
        return tsoa(frontSalt, middleSalt, backSalt, offsetValue, password);
    }

    public static String build(String frontSalt, String middleSalt, String backSalt, int offsetValue, String password){
        return tsoa(frontSalt, middleSalt, backSalt, offsetValue, password);
    }
